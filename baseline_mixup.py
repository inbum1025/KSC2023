...
class Model(pl.LightningModule):
    ...
    def visualize(self, test_dataloader, file_name):
        ...
        fig.show()
        fig.write_html(f"html/mixup/{file_name}.html")
